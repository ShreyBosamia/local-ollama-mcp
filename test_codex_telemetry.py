...
class CodexTelemetryTests(unittest.TestCase):
    ...
    def test_turn_summary_uses_exact_total_and_last_usage_payloads(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(turn["context_used_pct"], 5450.0)
    ...
    def test_echo_line_is_watcher_output(self) -> None:
        turn = {
            "input_tokens": 109000,
            "cached_input_tokens": 100000,
            "delta_output_tokens": 221,
            "delta_reasoning_output_tokens": 18,
        ...
        self.assertEqual(
            line,
            "codex-telemetry: tokens: in 109K (+100K cached), out 221, "
